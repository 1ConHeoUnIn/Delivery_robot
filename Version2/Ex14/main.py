...
def main():
    ...
    while True:
        ...
        elif key == ord('o'): # Tăng lực nhồi ga leo gờ
            engine.boost_speed = min(255, engine.boost_speed + 10)
        elif key == ord('l'): # Giảm lực nhồi ga leo gờ
            engine.boost_speed = max(80, engine.boost_speed - 10)
