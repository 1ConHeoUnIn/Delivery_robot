...
class FaceEngine:
    def __init__(self, video_source):
        ...
        self.min_speed = 40     # Tốc độ rà phanh khởi điểm
        self.max_speed = 80     # Tốc độ quay tối đa
        self.brake_ratio = 0.6  # Tỉ lệ khung hình để phanh
    ...
    def process_frame(self):
                ...
                if detected_status == "MASTER":
                    ...
                    if hand_raised:
                        ...
                        if error > 0.1:
                            ...
                            if w_box > (self.target_width * self.brake_ratio): 
                                command = "S" 
        ...
        if detected_status != "NOBODY":
            ...
            if self.status_counter > self.REQUIRED_STABLE_FRAMES:
                ...
                else: # <--- FIX: Thụt lề đoạn này vào trong 1 Tab
        ...
        # --- HIỂN THỊ HUD CALIB TỐC ĐỘ VÀ KHOẢNG CÁCH ---
